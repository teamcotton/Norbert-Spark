...
**Note**: PostgreSQL 18+ includes native `uuidv7()` function without requiring extensions. UUID v7 provides time-ordered UUIDs which improve database performance for indexed primary keys.
